<template>
  <div class="bg-white shadow-md rounded my-6">
    <table class="w-full">
      <thead>
        <tr
          class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal flex w-full"
        >
      ...
      >
        <TableGroup v-for="category in categories" :key="category.id" :category="category" :items="clients" :agents="agents"/>
      </tbody>
    </table>
  </div>
</template>
