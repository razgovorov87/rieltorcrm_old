        ...
        <div class="w-1/3 bg-white flex flex-col rounded">
            ...
            <div class="flex justify-center items-center px-6 py-4 border-b text-gray-600">
                <div class="flex-grow flex items-center">
                    ...
                    <span class="font-medium text-xl">Передать клиента другому агенту</span>
                </div>
                <button
            ...
            <div class="flex-grow py-4 px-6">
                ...
                <div class="flex-grow border rounded bg-white cursor-pointer relative border-gray-300 mb-2">
                    ...
                    >
                        <div class="bg-white flex flex-col border rounded shadow border-gray-100 overflow-hidden">
                            <span
                            v-for="(item, idx) in agents.filter(agent => agent.id !== client.agent && agent.verify && agent.status !== 'deleted')"
                            :key="item + idx"
...
export default {
    ...
    methods: {
        async switchAgent() {
            ...
            const agentId = this.agents.find(agent => (agent.surname + ' ' + agent.name) === this.newAgent).id
